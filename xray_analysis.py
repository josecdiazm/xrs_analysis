...
class xray_geometry():
    ...
    def define_detector(self):
        ...
        if self.detector == 'Pilatus1m':
        ...
        elif self.detector == 'Pilatus300k':
            ...
            raise Exception('Unknown detector. Should be either: Pilatus2m or Pilatus1m or '
                            'Pilatus300kw or Pilatus900kw or rayonix or Eiger2_1M or Pilatus300k')
    ...
    def open_data(self, path, lst_img, optional_mask=None):
        ...
        for i, (img, bs) in enumerate(zip(lst_img, self.bs)):
            ...
            if self.detector == 'Pilatus1m' or self.detector == 'Pilatus2m' or self.detector == 'Pilatus300k':
    ...
    def caking(self, radial_range=None, azimuth_range=None, npt_rad=500, npt_azim=500):
        ...
        if radial_range is None and ('Pilatus' in self.detector or 'Eiger2_1M' in self.detector):
            radial_range = (0.01, np.sqrt(self.qp[1] ** 2 + self.qz[1] ** 2))
        if azimuth_range is None and ('Pilatus' in self.detector or 'Eiger2_1M' in self.detector):
    ...
    def radial_averaging(self, radial_range=None, azimuth_range=None, npt=2000):
        ...
        if self.geometry == 'Transmission':
            ...
            if radial_range is None and (self.detector == 'Pilatus1m' or self.detector == 'Pilatus2m'
                                         or self.detector == 'Pilatus300k' or self.detector == 'Eiger2_1M'):
